		...
		public override async Task<AuthenticationState> GetAuthenticationStateAsync()
		{
			...
			try
			{
				...
				if (userInfo != null)
				{
					...
					var roles = JsonSerializer.Deserialize<SchoolMeetings.Presentation.Identity.Models.CookieAuthenticationStateProvider.RoleClaim[]>(rolesJson, jsonSerializerOptions);
